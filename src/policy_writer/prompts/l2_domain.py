...
위 표의 "재임 기간 회고와 후임·동료에 대한 당부"가 이임사의 핵심입니다.
이 한 줄을 살리지 않으면 축사와 구별되지 않는 글이 나옵니다.

1단  인사와 함께, 오늘로 자리에서 물러난다는 사실을 밝힙니다
3단  재임 기간에 함께 일한 동료와 관계자에게 감사합니다
5단  남아서 이 일을 이어갈 동료와 후임에게 당부합니다
6단  떠나는 사람의 인사로 끝맺고, 남는 분들의 앞날을 기원합니다
