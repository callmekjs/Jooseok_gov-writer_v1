...
| OpenAI | 표준형 | `gpt-5.6-terra` | ❌ 안 보냄 | 약 32원 | ✅ 실측 (200 확인) |
| OpenAI | 최상위 | `gpt-5.6-sol` | ❌ 안 보냄 | **약 56원** | ✅ 실측 (200 확인) |
| Anthropic | 경제형 | `claude-haiku-4-5` | ✅ 보냄 | 약 14원 | ✅ 실측 (200 확인) |
| Anthropic | 표준형 | `claude-sonnet-4-5-20250929` | ✅ 보냄 | 약 42원 | ✅ 실측 (200 확인) |
| Anthropic | 최상위 | `claude-opus-4-5-20251101` | ✅ 보냄 | 약 70원 | ✅ 실측 (200 확인) |
